				...
				<table border="0" width=100% cellspacing="4">
					...
					<tr>
						<td width="40%" bgcolor="#DDDDDD">
							...
							<input type="text" id="organization_search" autocomplete="off" size=20 onKeyUp="javascript:search_organization(this.value, 'ea_combo_org_info');" onBlur="javascript:sinc_combos_org(context.value, ea_check_allUsers.checked); get_available_sambadomains(context.value, '{type}')">
							<br>
						...
						<td width="40%" valign="bottom" bgcolor="#DDDDDD">
							{lang_search_organization}:<br>
							<input type="text" id="organization_search" autocomplete="off" size=20 onKeyUp="javascript:search_organization(this.value, 'ea_combo_org_groups');" onBlur="javascript:get_available_users(org_context.value, ea_check_allUsers.checked);">
							<br>						

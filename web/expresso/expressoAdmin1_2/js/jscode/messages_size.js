...
function add_user()
{
	...
	cShareMailbox.prototype.getaclfromuser = function(user)
	{
		...
		if (this.ownersAcl[user] != "false" && this.ownersAcl[user].indexOf('lrs',0) >= 0)
		{
		...
		if (this.ownersAcl[user] != "false" && this.ownersAcl[user].indexOf('d',0) >= 0)
		{
			Element('em_input_deleteAcl').checked = true;
		}
		if (this.ownersAcl[user] != "false" && this.ownersAcl[user].indexOf('wi',0) >= 0)
		{
			Element('em_input_writeAcl').checked = true;
		}		
		if (this.ownersAcl[user] != "false" && this.ownersAcl[user].indexOf('a',0) >= 0)
		{
			Element('em_input_sendAcl').disabled = false;
			Element('em_input_sendAcl').checked = true;
		}
		if (this.ownersAcl[user] != "false" && this.ownersAcl[user].indexOf('p',0) >= 0)
		{
			Element('em_input_saveAcl').disabled = false;
			Element('em_input_saveAcl').checked = true;
		}
		if (this.ownersAcl[user] != "false" && this.ownersAcl[user].indexOf('c',0) >= 0)
		{
			Element('em_input_folderAcl').checked = true;
		}
		if( this.ownersAcl[user] != "false" && Element('em_input_writeAcl').checked && Element('em_input_sendAcl').checked ){
			Element('em_input_saveAcl').disabled = false;

function assing_calendar_user(path){
	...
	if (!UI.dialogs.assingCalendar) {
			UI.dialogs.assingCalendar = jQuery('#assingCalendar').append('<div title="Compatilhamento de Agenda" class="assing-calendar active"> <div>').find('.assing-calendar.active').html(html).dialog({
				resizable: false, 
				modal:true, 
				autoOpen: false,
				width:620, 

...
function draw_organogram_control()
{
	...
	bt.onclick = function() { openParticipants('sel_org_user', 'hidegroups=1'); };
	td.appendChild(bt);
...
function draw_process_control()
{
	...
	bt.setAttribute('name','Selecionar');
	bt.setAttribute('value','Selecionar');
	bt.onclick = function() { openParticipants('sel_proc_user', ''); };
	td.appendChild(bt);
...
function draw_monitor_control()
{
	...
	bt.setAttribute('name','Selecionar');
	bt.setAttribute('value','Selecionar');
	bt.onclick = function() { openParticipants('sel_mon_user', ''); };
	td.appendChild(bt);
...
function draw_external_application_control()
{
	...
	content += '<td></td>';
	content += '<td align="right"><input type="button" name="Selecionar" value="Selecionar" onclick="openParticipants(\'sel_exa_user\', \'\')"/><input type="button" name="Remover" value="Remover" onclick="del_selected_reg(\'sel_exa_user\');"/></td>';
	content += '</tr>';
	content += '<tr><td colspan="3"></td></tr>';
...
function draw_administration_control()
{
	...
	content += '<td></td>';
	content += '<td align="right"><input type="button" name="Selecionar" value="Selecionar" onclick="openParticipants(\'selectWorkflowUsers\', \'\')"/><input type="button" name="Remover" value="Remover" onclick="del_selected_reg(\'selectWorkflowUsers\');"/></td>';
	content += '</tr>';
	content += '<tr><td colspan="3"></td></tr>';
	content += '</table></td></tr></table>';
...
function draw_development_control()
{
	...
	content += '<td></td>';
	content += '<td align="right"><input type="button" name="Selecionar" value="Selecionar" onclick="openParticipants(\'selectDevelopmentUsers\', \'\')"/><input type="button" name="Remover" value="Remover" onclick="del_selected_reg(\'selectDevelopmentUsers\');"/></td>';
	content += '</tr>';
	content += '<tr><td colspan="3"></td></tr>';
	content += '</table></td></tr></table>';

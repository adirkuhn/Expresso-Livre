        ...
        <table>
            <tr>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="window.location.href='<?=$BASE_URL?>';" <? if($abaMenu == 'pesquisa'){ echo 'class="active"'; }?>>Pesquisa</a>
                </td>
                <? if (($lstoid != "") || ($lstoid == "" && $FrmCadListagem_acao == "editar") ||  ($FrmCadListagem_acao == "atualizar_listagem")) { ?>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="javascript:mudaAba('cadastro');" <? if($abaMenu == 'cadastro'){ echo 'class="active"'; }?>>Cadastro</a>
                </td>
                <? } ?>
                <? if (($lstoid != "") ||  ($FrmCadListagem_acao == "atualizar_listagem")) { ?>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="javascript:mudaAba('colunas');" <? if($abaMenu == 'colunas'){ echo 'class="active"'; }?>>Colunas</a>
                </td>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="javascript:mudaAba('indicadores');" <? if($abaMenu == 'indicadores'){ echo 'class="active"'; }?>>Indicadores</a>
                </td>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="javascript:mudaAba('parametros');" <? if($abaMenu == 'parametros'){ echo 'class="active"'; }?>>Parametros</a>
                </td>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="javascript:mudaAba('preview');" <? if($abaMenu == 'preview'){ echo 'class="active"'; }?>>Pre-Visualizacao</a>
                </td>
                <? if ($habilitasincronizacao) { ?>
                <td align="center" id="tabnav">
                    <a href="javascript:void(null);" onclick="javascript:mudaAba('sincronizar');" <? if($abaMenu == 'sincronizar'){ echo 'class="active"'; }?>>Sincronizacao</a>
                </td> 
                <? } ?>
                <? } ?>
            </tr>

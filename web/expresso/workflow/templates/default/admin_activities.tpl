       ...
       <tr class="row_on">
         ...
         <td valign="top">
			...
			<div id="div_default_user_option_0" style="display:none;">
				...
				<a href="javascript:void(0)" onclick="openParticipants('default_user', 'uid=1&hidegroups=1');"><img border="0" src="workflow/templateFile.php?file=images/add_user.png" /></a>

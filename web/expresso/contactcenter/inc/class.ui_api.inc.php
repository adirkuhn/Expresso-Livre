		...
		function get_quick_add_plugin()
		{
			...
			for ($i = 0; $i < $nFields; $i++)
			{
				...
				if ($i == 0){
					...
					$fieldsHTML .= '<input id="ccQuickAddI'.$i.'" type="text" value="" onkeyup="emailTolower(\'ccQuickAddI' .$i. '\')" maxlength="100" style="position: absolute; top: '.($fieldsTop+$i*$fieldsSpace).'px; left: 110px; width: 135px;">'."\n";
				}else if ($i == 3){

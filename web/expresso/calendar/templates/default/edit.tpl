...
<form action="{action_url}" method="post" name="app_form" id="formEvent">
{common_hidden}
<table id="editFormTable" border="0" width="90%"   class="prefTable">
<input id="set_participants" style="visibility: hidden;" value="{lang_set_participants}"></input>
 <tr>
  <td colspan="2">
...
{row}
 <tr>
  ...
  <div style="padding-top:15px; padding-right: 2px">
  	...
  	<input id="submit_button" style="font-size:10px" type="button" value="{submit_button}"  onclick="javascript:submitValues(this);" ></div></form>
  </td>
  <td>{cancel_button}</td>
  </tr></table>
  </td>

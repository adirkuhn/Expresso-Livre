...
<td align='center' valign="bottom"><br><b>{lang_User_to_grant_access}</b><br>
	...
	<br>{lang_Search_for}: <input type="text" id="cal_input_searchUser1" name="cal_input_searchUser1" value="" size=30 autocomplete="off" onkeyup="javascript:search_object(this,'cal_span_searching1','user','u', event)"/>
	<br><br>
...
<td align='center' valign="bottom"><br><b>{lang_Group_to_share_calendar}</b><br>
	...
	<br>{lang_Search_for}:	<input type="text" id="cal_input_searchUser2" name="cal_input_searchUser2" value="" size=30 autocomplete="off" onkeyup="javascript:search_object(this,'cal_span_searching2','group','g', event)"/><br><br>

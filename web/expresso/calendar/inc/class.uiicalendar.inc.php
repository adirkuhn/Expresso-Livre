...
// 			$this->ui = CreateObject('calendar.uicalendar');
...
//			echo 'VAL = '._debug_array($val,False)."<br>\n";
		...
		function import_from_mail($calendar, $from_ajax, $importAccount = false) {
		...
		function import()
		{
			...
			$var = Array(
				...
				'action_url'	=> $GLOBALS['phpgw']->link('/index.php','menuaction=calendar.boicalendar.import&calendarImport=1'),

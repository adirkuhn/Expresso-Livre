...
class uireports_fpdf extends FPDF
{
	...
	/*	function Header()
	 {
		$SubTituloR = lang('report cota organization');
		...
		$this->Cell(95,5,lang('name'),1,0,'L',1);
		//				$pdf->Cell(53,5,lang('report email'),1,0,'L',1);
		$this->Cell(17,5,lang('cota'),1,0,'C',1);
		$this->Cell(31,5,lang('cota used'),1,0,'C',1);
		$this->Cell(29,5,lang('percent cota'),1,0,'C',1);
		$this->Cell(20,5,lang('status'),1,1,'C',1);
	...
	function Footer()
	{
		...
		//		$this->Cell(0,5,$titulo_system.'                  '.$SubTitulo.'                  Página n. '.$this->PageNo(),1,0,'C',1);

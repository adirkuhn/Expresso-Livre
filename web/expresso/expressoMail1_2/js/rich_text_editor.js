...
cRichTextEditor.prototype.getSignaturesOptions = function() {
   	...
   	var signatures = this.fromJSON( preferences.signatures );
	var signature_types = this.fromJSON( preferences.signature_types );
...
cRichTextEditor.prototype.getSignatureDefault = function() {
        ...
        if(!RichTextEditor.signatures ||  
           !RichTextEditor.signatures[preferences.signature_default || ""])
        {
          preferences.use_signature = "0"; //Desabilita o uso da assinatura
          return '';
        } 
        
        return unescape(RichTextEditor.signatures[preferences.signature_default]);

...
function validateSignature()
{
	...
	var key = document.getElementById( "title_signature" + i ).value;
...
function loadSignature()
{
    ...
    var signatures = fromJSON( document.getElementById( "signatures" ).value );
    ...
    {
	addSignature( document.getElementById("type_signature").value !== "html" );

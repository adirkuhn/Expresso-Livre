...
<div style="display:none; width: auto; min-height: 0px; height: 410px; overflow: hidden" id="dialog-modal" class="dialog-modal expressomail-qs-container" title="{lang_quick_search_users_dialog_title}">
 		                <div id="accordion"> 
							...
							<input class="button" type="button" onClick="show_help()" style="background-image: url('./templates/default/images/information.png'); background-repeat: no-repeat;"/>
 		                 </div>   
 		             </div> 
...
<div id="import-dialog" title="Importar Evento" style="display:none">

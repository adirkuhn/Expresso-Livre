   ...
   <form method="POST" action="{form_action}">
    <table border="0">
     <tr>
       ...
       <td>
        <input type="input" autocomplete="off" name="telephonenumber" size=12 value="{telephonenumber}" maxlength="13" onkeyUp="FormatTelephoneNumber(event, this);">&nbsp;(xx)xxxx-xxxx
       </td>
     </tr>
     <tr>
     ...
     <tr>
       ...
       <td>
        <input type="input" autocomplete="off" name="mobile" size=12 value="{mobile}" maxlength="13" onkeyUp="FormatTelephoneNumber(event, this);">&nbsp;(xx)xxxx-xxxx
       </td>
     </tr>
     <tr>
       <td>
       ...
       <td>
        <input type="input" autocomplete="off" name="homephone" size=12 value="{homephone}" maxlength="13" onkeyUp="FormatTelephoneNumber(event, this);">&nbsp;(xx)xxxx-xxxx
       </td>
     </tr>
	 <tr>
       <td>{lang_birthday}:</td>

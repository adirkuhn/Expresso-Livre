<?php
	...
	* the absolute path to fit your site, and you should be up and running.    *
	\**************************************************************************/
	ob_start();
	define('PHPGW_SERVER_ROOT','/home/cristiano/Symfony/web/expresso');
	define('PHPGW_INCLUDE_ROOT','/home/cristiano/Symfony/web/expresso');
	$GLOBALS['phpgw_info']['server']['header_admin_user'] = 'expresso-admin';
	$GLOBALS['phpgw_info']['server']['header_admin_password'] = '98d754a91e1d71291490ddea6ed655a9';
	...
	$GLOBALS['phpgw_info']['server']['num_badlogin'] = 3;
	...
	$GLOBALS['phpgw_info']['server']['sugestoes_email_to'] = 'suporte@prognus.com.br, william@prognus.com.br';
	$GLOBALS['phpgw_info']['server']['domain_name'] = 'prognus.org';
	...
	$GLOBALS['phpgw_domain']['default'] = array(
		...
		'config_passwd' => '98d754a91e1d71291490ddea6ed655a9'
	);
	...
	*/
	$GLOBALS['phpgw_info']['server']['mcrypt_iv'] = 'lJY89YiKgIrSps7xisDFh9UevXXEU';
	...
	* Do not edit these lines                                                  *
	...
	unset($setup_info);
	$GLOBALS['phpgw_info']['server']['versions']['header'] = '2.4.0';
